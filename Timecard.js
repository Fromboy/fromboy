...
[Script]
假日提醒 = type = generic,timeout=30,script-path=https://raw.githubusercontent.com/Fromboy/JavaScript/Scripts/Timecard.js

或者直接添加定时任务：
[Script]
假日提醒 = type = cron,timeout=30,wake-system=1,cronexp=30 7 * * *, script-path=https://raw.githubusercontent.com/Fromboy/JavaScript/Scripts/Timecard.js
...
[task_local]
# 节假提醒
0 7 * * * https://raw.githubusercontent.com/Fromboy/JavaScript/Scripts/Timecard.js, tag=节假提醒, img-url=https://raw.githubusercontent.com/Koolson/Qure/master/IconSet/Color/Daily.png, enabled=true
...
let defaultDaysData =
    ...
    {'date': '2024-7-10', 'name': '老婆生日'},
    {'date': '2024-8-26', 'name': '多多生日'},
    {'date': '2024-11-3', 'name': '妹妹生日'},
    {'date': '2024-11-7', 'name': '肖丽生日'}  ] // 内置假日
